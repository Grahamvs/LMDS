...
declare -A cont_array=(
	...
	[audiobookshelf]="Audiobookshelf - Media server for audiobooks and podcasts"
	...
	[watchtower]="Watchtower - Auto updates Docker containers"
	[homarr]="Homarr - A simple, yet powerful dashboard for your server"
